...
- Core repository entry `fold-engine` acts as the public fold landing page.
- The fold encodes set `S` via compression mapping `c: S → F`.
...
- Flesh out the Borel-like structure details.
- Annotate the compression mapping with concrete examples.
